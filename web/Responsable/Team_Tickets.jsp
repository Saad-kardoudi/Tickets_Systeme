<%-- 
    Document   : Team_Tikest
    Created on : 31 mai 2020, 15:40:04
    Author     : LEGION
--%>
            ...
            <table class="table" id="table">
                ...
                <tbody>
                  <%
                     ...
                     ResultSet rs =CNX.Select_requwest("SELECT ID_TICKET ,LIBELLE,to_char(DATE_OVERTURE,'yyyy-MM-dd'),PRENOM,NOM ,ETAT,DESCRIPTION,COMMENTAIRE FROM TICKER.TICKET join UTILISATEUR ON UTILISATEUR.ID_USER=TICKET.ID_USER inner join EQUIPE on UTILISATEUR.ID_EQUIPE=EQUIPE.ID_EQUIPE WHERE TICKET.ID_EQUIPE=(SELECT id_equipe FROM equipe where id_manager="+id_tech+")");                      
                       while (rs.next()) {
                  %>  
                  <tr>                    
                    ...
                    data-ticket="<%=rs.getString(1)%>"data-description="<%=rs.getString(7)%>"data-comment="<%=rs.getString(8)%>" title="View Details">
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-primary"id="save_comment">Comment</button> 
